            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <br>
                        <p>We would like to confirm that we have taken a construction finance on the said Project of Rs. <input type="text" name="field_13" class="form-control input-sm" style="display:inline-block; width:auto;" />Cr. From <input type="text" name="field_14" class="form-control input-sm" style="display:inline-block; width:auto;" /> via Sanction Letter dated <input type="text" name="field_15" class="form-control input-sm" style="display:inline-block; width:auto;" />. </p>
                        <br>
                        <p>We hereby also confirm that thesaid flats/duplex/tenaments/plot is subject to the charge of <input type="text" name="field_16" class="form-control input-sm" style="display:inline-block; width:auto;" /> and as per the Provisional NOC of <input type="text" name="field_17" class="form-control input-sm" style="display:inline-block; width:auto;" />dated <input type="text" name="field_18" class="form-control input-sm" style="display:inline-block; width:auto;" />, the charge would be released after the payment of the consideration amount in the account mentioned as per Provisional NOC/ Sanction Letter. </p>
                        <br>
