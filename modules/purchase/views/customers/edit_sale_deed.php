                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="section box">
                            <p class="center">The Sale Deed of Residential <strong>Flat No.<span class="u"><?= $flat_name ?></span> </strong> in Wing <strong>“<?php echo $block_name ?>”</strong>, having total Carpet Area admeasuring <strong><?= $banakhat_details->carpet_area ?> sq.mtrs.</strong>, situated on <strong><?= $floor_name ?></strong>, along with (i) <strong>Wash Area <?= $banakhat_details->wash_yard ?> sq.mtrs.</strong> (ii) Balcony <strong><?= $banakhat_details->balcony ?> sq.mtrs.</strong>, in the scheme known as <strong>“KAUTILYA ONE-54”</strong> together with undivided share in land <strong><?= round($banakhat_details->undivided_land_share, 2) ?> sq.mtrs</strong>, at the price of Rs. <strong><?= $customer['final_amount'] ?></strong> (Rupees <strong><?= convertToIndianCurrency($customer['final_amount']) ?> only</strong>).</p>
                        </div>
                        ...
                        <p><strong>Block No. Case No. (Rajachitthi No.)</strong>
                            A + B BHNTI / WZ / 210522 / CGDCRV / A6107 / R0 / M1
                            (Rajachitthi No. 06627 / 210522 / A6107 / R0 / M1)

                            C BHNTS / WZ / 210522 / CGDCRV / A6108 / R0 / M1
                            (Rajachitthi No. 06628 / 210522 / A6108 / R0 / M1)

                            D BHNTS / WZ / 210522 / CGDCRV / A6109 / R0 / M1
                        ...
                        <p>8) Thereafter the Second Party contacted the First Party and desired to purchase <strong>Unit No. <?= $flat_name ?></strong> in <strong>Wing “ <?= $block_name ?> ”</strong> having total Carpet Area admeasuring about <strong><?= $banakhat_details->carpet_area ?> sq.mtrs.</strong> situated on <strong>“ <?= $floor_name ?> ”</strong> of the said Scheme along with (i) Wash Area admeasuring <strong><?= $banakhat_details->wash_yard ?> sq.mtrs.</strong>. (ii) Balcony admeasuring about <strong><?= $banakhat_details->balcony ?> sq.mtrs.</strong>. in the scheme known as “ KAUTILYA ONE-54 ” together with undivided share in the said land admeasuring about <strong> <?= round($banakhat_details->undivided_land_share, 2) ?> Sq.Mtrs.</strong> bearing A) Final Plot No. 321, admeasuring 3400 sq.mtrs. of Town Planning Scheme No. 76 / B (Chandkheda), allotted in lieu of Survey No. 875/3 admeasuring 5666 sq.mtrs. & b) Final Plot No. 322, admeasuring 2125 sq.mtrs. of Town Planning Scheme No. 76 / B (Chandkheda), allotted in lieu of Survey No. 875/4 admeasuring 3541 sq.mtrs. situated within the village limits of Chandkheda, Taluka - Sabarmati in the Registration Sub - District of Ahmedabad - 13 (Sabarmati) of District Ahmedabad. The Unit and right to use common amenities, membership and share certificate right of Service Society shall be referred to as “ THE SAID PROPERTY ” OR “ THE SAID UNIT ” OR “ THE SAID FLAT ” hereinafter in this Sale-Deed and more particularly described in the Schedule.</p>

                        <p>[a] The Purchaser hereby agrees to purchase from the Vendor and the Vendor hereby agrees to sell the Purchaser <strong>Unit No. <?= $flat_name ?></strong> in <strong>Wing “ <?= $block_name ?> ”</strong> having total carpet area admeasuring <strong><?= $banakhat_details->carpet_area ?> sq.mtrs.</strong> on <strong>“ <?= $floor_name ?> ”</strong> in the scheme known as “

                            KAUTILYA ONE-54 ” for the consideration of Rs.<strong><?= $customer['final_amount'] ?></strong>/-

                            along with facilities appurtenant to the Unit, the nature, extent and description of common areas and facilities like Lift, Staircase, Passage, Foyer, Underground Water Tank, Overhead Water Tank, Open Terrace, Roads, Open Space, Parking, Fire Safety Equipments

                            / System, C.C.T.V. Camera, Security System.
                        </p>
                        ...
                        <p>[c] The Purchaser hereby agrees to purchase from the Vendor and the Vendor hereby agrees to sell to the Purchaser wash area admeasuring <strong><?= $banakhat_details->wash_yard ?> sq.mtrs.</strong> forming part of the said Unit and consideration of the same is included in total consideration.<br>
                            The area of [b] balcony having area admeasuring <strong><?= $banakhat_details->balcony ?> sq.mtrs.</strong> and [c] wash area admeasuring <strong><?= $banakhat_details->wash_yard ?> sq.mtrs.</strong> is included in total Carpet area admeasuring <strong><?= $banakhat_details->carpet_area ?> sq.mtrs.</strong> of said Unit.
                        </p>
                        ...
                        <p>[f] Thereafter the First Par ty and Second Par ty have executed Agreement for Sale of said Unit which was registered before Sub- Registrar of Ahmedabad - 13 (Sabarmati) under Sr. No. ______, dated__________, herein after referred to as “ The said Agreement”.</p>
                        ...
                        <p>All That piece & parcel of Immovable property bearing <strong>Flat No. <?= $flat_name ?></strong> in <strong>Wing “ <?= $block_name ?> ” </strong> having total Carpet Area admeasuring

                            about <strong><?= $banakhat_details->carpet_area ?> sq.mtrs carpet area</strong> situated on <strong><?= $floor_name ?></strong> of the said Scheme along with (i) Wash Area admeasuring <strong>wash area <?= $banakhat_details->wash_yard ?> sq.mtrs</strong>. (ii) Balcony admeasuring about <strong>balcony <?= $banakhat_details->balcony ?> sq.mtrs</strong>. in the scheme known as “KAUTILYA ONE-54 ” together with undivided share in the said land admeasuring about <strong><?= round($banakhat_details->undivided_land_share, 2) ?> sq.mtrs</strong> bearing A) Final Plot No. 321, admeasuring 3400 sq.mtrs. of Town Planning Scheme No. 76 / B (Chandkheda), allotted in lieu of Survey No. 875/3 admeasuring 5666 sq.mtrs. & b) Final Plot No. 322, admeasuring 2125 sq.mtrs. of Town
                            Planning Scheme No. 76 / B (Chandkheda), allotted in lieu of Survey No. 875/4 admeasuring 3541 sq.mtrs. situated within the village limits of Chandkheda, Taluka - Sabarmati in the Registration Sub - District of Ahmedabad - 13 (Sabarmati7) of District Ahmedabad.
                        </p>
