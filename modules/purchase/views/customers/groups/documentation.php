   ...
   <div class="col-md-12">
      ...
      <div class="tab-content">
         ...
         <div role="tabpanel" class="tab-pane<?php if (!$this->input->get('tab')) {
            ...
            <p>THIS AGREEMENT FOR SALE is made and executed at Ahmedabad on this <input type="text" name="date" class="form-control input-sm" style="display:inline-block; width:auto;" placeholder="Date" value="<?php echo $date_value; ?>" /> day of <input type="text" name="month" class="form-control input-sm" style="display:inline-block; width:auto;" placeholder="Month" value="<?php echo $month_value; ?>" />, <input type="text" name="years" class="form-control input-sm" style="display:inline-block; width:auto;" placeholder="Year" value="<?php echo $year_value; ?>" />.</p><br>
            <p>BETWEEN</p><br>
            <p><i class="fa fa-arrow-right"></i> kautilya Developers PAN : AATFK 6344 G</p><br>
            ...
            <?php $commencement_letter_no_value = (isset($documentation) ? $documentation[0]['commencement_letter_no'] : '') ?>
            <p>(D) Ahmedabad Municipal Corporation granted permission for construction on said land by following Commencement Letter <input type="text" name="commencement_letter_no" class="form-control input-sm" style="display:inline-block; width:auto;" value="<?php echo $commencement_letter_no_value; ?>" /> issued on 28th July, 2022 and granted Development Permission.</p><br>
            ...
            <?php $flat_no_value = (isset($documentation) ? $documentation[0]['flat_no'] : '') ?>
            <?php $block_value = (isset($documentation) ? $documentation[0]['block'] : '') ?>
            <?php $area_value = (isset($documentation) ? $documentation[0]['area'] : '') ?>
            ...
            <?php $flat_no2_value = (isset($documentation) ? $documentation[0]['flat_no2'] : '') ?>
            <?php $block2_value = (isset($documentation) ? $documentation[0]['block2'] : '') ?>
            ...
            <p><i class="fa fa-arrow-right"></i> kautilya Developers</p>
            ...
            <br>
            <p><i class="fa fa-arrow-right"></i> kautilya Developers - A Partnership Firm through its authorise signatory Kiran Rasiklal Kamdar</p><br>
