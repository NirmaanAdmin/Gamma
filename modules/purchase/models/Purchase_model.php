...
class Purchase_model extends App_Model
{
    ...
    public function get_sale_agreement_pdf_html($sale_agreement_id)
    {
        ...
        <li>In the event of sale not being completed due to any willful delay or default on the part of the Vendor, the Party of the Second Part shall have right to require specific performance by the Vendor of this agreement.</li>

        <li>The Purchaser will have to compulsorily become the member and obey the rules and regulations of the maintenance body to be formed in future. The purchaser will have to pay the amount of maintenance deposit, without any objection, to be collected by the maintenance body, in future.</li>
        ...
        <li>The purchaser cannot give the said property on lease, sub-lease, rent, leave and license or in any manner for his/her/their/its personal benefit till the total sale consideration of the said property is completed.</li>

        <li>The Purchaser cannot transfer the said property to anybody on the basis of this Agreement for Sale.</li>

        <li>The Purchaser/s are not entitled to make any change in interior/exterior elevation, exterior colour scheme of the said scheme. The Purchaser/s shall not be entitled to make any change/alteration in internal / external structure of the Said Property.</li>

        <li>The Purchaser/s is required to keep the ‘Said Property’, walls and partition walls, sewers, drains, pipes and appurtenances thereto belonging to, in good and tenantable repair and conditions and in particular so as to support, shelter and protect the parts of the building other than their property.</li>

        <li>The Purchaser shall have to maintain at their cost, the ‘Said Property’ in good condition, state and order, in which it is delivered to them and shall abide by all byelaws, rules and regulations of the government, electricity charges, local bodies and other authorities.</li>

        <li>The Purchaser shall have to pay / contribute proportionate amount to service society / association formed for the maintenance of said “KAUTILYA ONE-54” Scheme.</li>

        <li>The Party of the Second Part will have access rights to all common amenities and common areas provided by the Party of the First Part. The Party of the Second Part will also not claim individual ownership rights in the undivided share in land.</li>

        <li>The Party of the Second Part shall have absolute right, interest, in the “Said Property” only after the date of final Sale Deed and after the possession of property, which shall be given at the time of execution of Sale Deed till such date the Party of Second Part shall not have any such claim or right to “Said Property”. he / she / they / it shall not claim any right, title, interest in any other common property of the Said Scheme.</li>
        ...
        <li>This Agreement for sale is to be read and understood as per the provisions made under the Real Estate (Regulation and Development) Act, 2016 and under the rules of the Gujarat Real Estate (Regulation and Development) (General) Rules, 2017.</li>

        <li>Any dispute between parties shall be settled amicably. In case of failure to settled the dispute amicably, which shall be referred to the RERA authority as per the provisions of the Real Estate (Regulation and Development) Act, 2016, Rules and Regulations, thereunder.</li>

        <li>That the rights and obligations of the parties under or arising out of this Agreement shall be construed and enforced in accordance with the laws of India for the time being in force and the Ahmedabad courts will have the jurisdiction for this Agreement.</li>
    ...
    public function get_sale_deed_pdf_html($sale_agreement_id)
    {
        ...
        if (!empty($customer2)) {
            $customer2_html = "
            (2) <strong>{$CUSTOMER2_COMPANY}</strong><br>
            [ PAN : <strong>{$CUSTOMER2_PAN_CARD}</strong>]
            [ AADHAR : <strong>{$CUSTOMER2_ADHAR_CARD}</strong>]<br>
            Adult Residing at - <strong>{$CUSTOMER2_ADDRESS}</strong><br>";
        }
...
<body>
    ...
    <div class="section box">
        <p class="center">The Sale Deed of Residential <strong>Flat No. <span class="u">{$flat_name}</span></strong> in Wing <strong>"{$block_name}"</strong>, having total Carpet Area admeasuring <strong>{$CARPET_AREA} sq.mtrs.</strong>, situated on <strong>{$floor_name}</strong>, along with (i) <strong>Wash Area {$WASH_YARD} sq.mtrs.</strong> (ii) Balcony <strong>{$BALCONY} sq.mtrs.</strong>, in the scheme known as <strong>"KAUTILYA ONE-54"</strong> together with undivided share in land <strong>{$UNDIVIDED_LAND_SHARE} sq.mtrs</strong>, at the price of Rs. <strong>{$FINAL_AMOUNT}</strong> (Rupees <strong>{$FINAL_AMOUNT_WORDS} only</strong>).</p>
    </div>
    
    <h4>FIRST PARTY - VENDOR :-</h4>
    <p><span>KAUTILYA DEVELOPERS</span><br> <span>PAN : AATFK 6344 G</span></p>
    <p>A Partnership Firm, having its Registered office at : 16, Dena Bank Society, Near Kiran Park, Nava Vadaj, Ahmedabad - 380013 & having site office at, "Kautilya One-54", located at Opp. Swaminarayan Temple, B/h. Omkar Lotus, Chandkheda, Ahmedabad.</p>
    <p>Here inafter in this Deed of Sale referred to as <strong>"THE VENDOR"</strong> or <strong>"THE FIRST PARTY"</strong> which expression shall unless it be repugnant to the context or meaning thereof be deemed to mean and include the said <strong>"VENDOR"</strong> and its present and future partners, authorized signatories, successors, agents, administrators, legal representative and assignees of the FIRST PARTY.</p>
    ...
    <p>Here inafter in this Deed of Sale referred to as <strong>"THE PURCHASER"</strong> or <strong>"THE SECOND PARTY"</strong> which expression shall unless it be repugnant to the context or meaning thereof be deemed to mean and include the said <strong>"PURCHASER"</strong> and his / her / their heirs, agents, administrators, legal representative and assignees of the SECOND PARTY.</p>

    <p>1) The developer is seized and possessed of or otherwise well sufficiently entitled to all that piece and parcel of land bearing 1) Final Plot No. 321, admeasuring 3400 sq.mtrs. of Town Planning Scheme No. 76 / B (Chandkheda), allotted in lieu of Survey No. 875/3 admeasuring 5666 sq.mtrs. & 2) Final Plot No. 322, admeasuring 2125 sq.mtrs. of Town Planning Scheme No. 76 / B (Chandkheda), allotted in lieu of Survey No. 875/4 admeasuring 3541 sq.mtrs. situated within the village limits of Chandkheda, Taluka - Sabarmati in the Registration Sub - District of Ahmedabad - 13 (Sabarmati) of District Ahmedabad. Hereinafter referred to as "the said land".</p>

    <p>2) The Non-Agricultural Permission for Residencial & Commercial purpose of the "Said Land" was granted by the Hon' District Collecter, Ahmedabad under 1) Order No. CB / NA / AHMEDABAD / CHANDKHEDA / 875 / 3 / 1009284 / 2019 on 03-06-2019 for Survey No. 875 / 3 of Mouje Chandkheda and entry to that effect was mutated in the revenue record by mutation entry No. 13606 dated : 15-06-2019, which were certified by the competent authority on 29-07-2019 & 2) Order No. CB / LAND-1 / NA / SR - 956 / 2018 / FMPS NO - 323282 on 29-10-218 for Survey No. 875 / 4 of Mouje Chandkheda and entry to that effect was mutated in the revenue record by mutation entry No. 13372 dated : 15-12-2018, which were certified by the competent authority on 28-01-2019</p>

    <p>3) The Vendor has purchased the Said land Paiki 1) Survey No. 875 / 3 from Daksh enterprise, a partnership firm by sale deed registered in the office of the Sub-Registrar of Assurances of Ahmedabad - 2 (Vadaj) under Serial No. 5406, dated : 04-04-2022 and entry to that effect was mutated in the revenue record by mutation entry No. 14858, Dated : 12-04-2022, Which was certified by the competent authority on 13-05-2022 & 2) Survey No. 875 / 4 from Jayantibhai Prahladbhai Nayak, Dilipkumar alias Bipinkumar Prahladbhai Nayak, Rajendrakumar Prahladbhai Nayak, Kailasben D/o. Prahladbhai Nayak W/o. Kundanlal Nayak, Sudhaben
sq.mtrs. of Town Planning Scheme No. 76 / B (Chandkheda), allotted in lieu of Survey No. 875/4 admeasuring 3541 sq.mtrs. situated within the village limits of Chandkheda, Taluka - Sabarmati in the Registration Sub - District of Ahmedabad - 13 (Sabarmati) of District Ahmedabad. The Unit and right to use common amenities, membership and share certificate right of Service Society shall be referred to as "THE SAID PROPERTY" OR "THE SAID UNIT" OR "THE SAID FLAT" hereinafter in this Sale-Deed and more particularly described in the Schedule.</p>

    <p>[a] The Purchaser hereby agrees to purchase from the Vendor and the Vendor hereby agrees to sell the Purchaser <strong>Unit No. {$flat_name}</strong> in <strong>Wing "{$block_name}"</strong> having total carpet area admeasuring <strong>{$CARPET_AREA} sq.mtrs.</strong> on <strong>"{$floor_name}"</strong> in the scheme known as "KAUTILYA ONE-54" for the consideration of Rs.<strong>{$FINAL_AMOUNT}</strong>/- along with facilities appurtenant to the Unit, the nature, extent and description of common areas and facilities like Lift, Staircase, Passage, Foyer, Underground Water Tank, Overhead Water Tank, Open Terrace, Roads, Open Space, Parking, Fire Safety Equipments / System, C.C.T.V. Camera, Security System.</p>
    ...
    <p>[c] The Purchaser hereby agrees to purchase from the Vendor and the Vendor hereby agrees to sell to the Purchaser wash area admeasuring <strong>{$WASH_YARD} sq.mtrs.</strong> forming part of the said Unit and consideration of the same is included in total consideration.<br>
        The area of [b] balcony having area admeasuring <strong>{$BALCONY} sq.mtrs.</strong> and [c] wash area admeasuring <strong>{$WASH_YARD} sq.mtrs.</strong> is included in total Carpet area admeasuring <strong>{$CARPET_AREA} sq.mtrs.</strong> of said Unit.
    </p>

    <p>[e] In the said scheme It is decided that unit No. A-101, A-102, A-103, A-104, B-101, B-102, B-103, B-104, C-101, C-102, C-103, C-104, D-101, D-102, D-103 & D-104 are agreed to be allotted to the respective Unit holders for their permanent individual right to use of the said open terrace as ingress and outgress of the said terrace has been given from the respective Unit as per the approved plans. The Purchaser and other members of the scheme have unconditionally agreed to the said arrangement and additional right to use to the respective Unit-holders.</p>

    <p>[f] Thereafter the First Party and Second Party have executed Agreement for Sale of said Unit which was registered before Sub- Registrar of Ahmedabad - 13 (Sabarmati) under Sr. No. ______, dated__________, herein after referred to as "The said Agreement".</p>
    ...
    <p style="text-align: center;"><strong>// PROPERTY SCHEDULE //</strong></p>
    <p>All That piece & parcel of Immovable property bearing <strong>Flat No. {$flat_name}</strong> in <strong>Wing "{$block_name}"</strong> having total Carpet Area admeasuring about <strong>{$CARPET_AREA} sq.mtrs carpet area</strong> situated on <strong>{$floor_name}</strong> of the said Scheme along with (i) Wash Area admeasuring <strong>wash area {$WASH_YARD} sq.mtrs</strong>. (ii) Balcony admeasuring about <strong>balcony {$BALCONY} sq.mtrs</strong>. in the scheme known as "KAUTILYA ONE-54" together with undivided share in the said land admeasuring about <strong>{$UNDIVIDED_LAND_SHARE} sq.mtrs</strong> bearing A) Final Plot No. 321, admeasuring 3400 sq.mtrs. of Town Planning Scheme No. 76 / B (Chandkheda), allotted in lieu of Survey No. 875/3 admeasuring 5666 sq.mtrs. & b) Final Plot No. 322, admeasuring 2125 sq.mtrs. of Town Planning Scheme No. 76 / B (Chandkheda), allotted in lieu of Survey No. 875/4 admeasuring 3541 sq.mtrs. situated within the village limits of Chandkheda, Taluka - Sabarmati in the Registration Sub - District of Ahmedabad - 13 (Sabarmati7) of District Ahmedabad.</p>
    ...
    <table class="table">
        <tr>
            ...
            <td><span class="u" style="min-width: 280px;">:by ______________</span></td>
        </tr>
        <tr>
            <th>On or towards West</th>
            <td><span class="u">:by ______________</span></td>
        </tr>
        <tr>
